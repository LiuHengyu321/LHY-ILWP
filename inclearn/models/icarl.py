...
class ICarl(IncrementalLearner):
    ...
    def _before_task(self, train_loader, val_loader):
        ...
        self._network.add_classes(self.train_fine_num_inc, 0, 0)
    ...
    def compute_accuracy(model, loader, class_means):
        features, fine_targets_, coarse_targets_ = utils.extract_features(model, loader)
        ...
        return score_icarl, fine_targets_
